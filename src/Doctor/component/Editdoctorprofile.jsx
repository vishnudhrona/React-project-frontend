...
const Editdoctorprofile = () => {
    ...
    useEffect(() => {
        instance.get(`/doctors/fetcheditprofile?doctorId=${doctorId}`).then((response) => {
            setFormData(response.data.doctorProfile)
        })
    }, [])
    ...
    const submit = (e) => {
        ...
        try {
            ...
            instance.post('/doctors/updatedoctorprofile',formDataToSend, { headers : { 'Content-Type' : 'multipart/form-data' }}).then((response) => {
                if(response.data.updateDocProfile.status) {
        ...
        <div className="flex justify-center items-center pb-5 ">
            <div className="signup-overlayrounded shadow-md p-5">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="w-full bg-buttonColor text-white p-2 mb-2 rounded hover:bg-green-500"
                    >
                        Submit
                    </button>
                </form>
