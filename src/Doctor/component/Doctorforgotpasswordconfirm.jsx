...
const Doctorforgotpasswordconfirm = () => {
    ...
    const handleResend = () => {
        ...
        instance.post('/doctors/docresendotp',{doctorEmail})
      }
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            instance.post('/doctors/doctorforgotpasswordconfirm', {
                otp : formData.otp,
...
export default Doctorforgotpasswordconfirm
